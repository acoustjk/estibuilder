...
const STANDARD_LABOR_DB = [
    ...
    { code: "통신 3-5-3", name: "PVC몰딩 및 알루미늄몰딩(바닥)", spec: "표준 규격", unit: "10m", laborType: "통신내선공", laborFactor: 0.25, category: "pipe", keywords: ["PVC몰딩 및 알루미늄몰딩(바닥)"] },
    ...
    { code: "통신 3-7-1", name: "--방 화 폼 설 치- ℓ---0.30케 이 블 표 시식별표시용 PVC", spec: "표준 규격", unit: "개", laborType: "보통인부", laborFactor: 0.01, category: "pipe", keywords: ["--방 화 폼 설 치- ℓ---0.3"] },
    ...
    { code: "통신 4-1-1", name: "광섬유케이블포 설(싱 글/멀 티 모 드)지중인력견인포설100m0.94--1.41기계견인포설", spec: "표준 규격", unit: "개", laborType: "광케이블설치사", laborFactor: 0.48, category: "cable", keywords: ["광섬유케이블포 설(싱 글/멀 티 모 "] },
    { code: "통신 4-1-1", name: "광섬유케이블포 설(싱 글/멀 티 모 드)지중인력견인포설100m0.94--1.41기계견인포설", spec: "표준 규격", unit: "개", laborType: "특별인부", laborFactor: 0.48, category: "cable", keywords: ["광섬유케이블포 설(싱 글/멀 티 모 "] },
    { code: "통신 4-1-1", name: "광섬유 가 공 포 설", spec: "표준 규격", unit: "개", laborType: "광케이블설치사", laborFactor: 1.35, category: "cable", keywords: ["광섬유 가 공 포 설"] },
    { code: "통신 4-1-1", name: "광섬유 가 공 포 설", spec: "표준 규격", unit: "개", laborType: "보통인부", laborFactor: 1.01, category: "cable", keywords: ["광섬유 가 공 포 설"] },
    ...
    { code: "통신 4-1-3", name: "광코어 공압포설(집합광섬유) 4코어 이하", spec: "표준 규격", unit: "개", laborType: "보통인부", laborFactor: 8.0, category: "cable", keywords: ["광코어 공압포설(집합광섬유) 4코어 "] },
    { code: "통신 4-1-3", name: "광섬유 광튜브 포설7튜브 이하", spec: "표준 규격", unit: "개", laborType: "광케이블설치사", laborFactor: 0.49, category: "cable", keywords: ["광섬유 광튜브 포설7튜브 이하"] },
    { code: "통신 4-1-3", name: "광섬유 광튜브 포설7튜브 이하", spec: "표준 규격", unit: "개", laborType: "보통인부", laborFactor: 0.838, category: "cable", keywords: ["광섬유 광튜브 포설7튜브 이하"] },
    { code: "통신 4-1-3", name: "광섬유 튜브 이상", spec: "표준 규격", unit: "개", laborType: "광케이블설치사", laborFactor: 0.58, category: "cable", keywords: ["광섬유 튜브 이상"] },
    { code: "통신 4-1-3", name: "광섬유 튜브 이상", spec: "표준 규격", unit: "개", laborType: "보통인부", laborFactor: 0.95, category: "cable", keywords: ["광섬유 튜브 이상"] },
    { code: "통신 4-1-3", name: "광섬유", spec: "표준 규격", unit: "소", laborType: "광케이블설치사", laborFactor: 0.07, category: "cable", keywords: ["광섬유"] },
    { code: "통신 4-1-3", name: "광섬유 광인출구 설치-", spec: "표준 규격", unit: "10개", laborType: "광케이블설치사", laborFactor: 0.18, category: "cable", keywords: ["광섬유 광인출구 설치-"] },
    ...
    { code: "통신 4-3-1", name: "UTP, STP, FTP구내 4P", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.15, category: "cable", keywords: ["UTP, STP, FTP구내 4P"] },
    { code: "통신 4-3-1", name: "UTP 25P", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.24, category: "cable", keywords: ["UTP 25P"] },
    { code: "통신 4-3-1", name: "UTP 50P", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.35, category: "cable", keywords: ["UTP 50P"] },
    { code: "통신 4-3-1", name: "UTP 100P", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.5, category: "cable", keywords: ["UTP 100P"] },
    { code: "통신 4-3-1", name: "UTP 옥외 4P이하", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.05, category: "cable", keywords: ["UTP 옥외 4P이하"] },
    { code: "통신 4-3-1", name: "UTP Thin", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.18, category: "cable", keywords: ["UTP Thin"] },
    { code: "통신 4-3-1", name: "UTP Thick", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.32, category: "cable", keywords: ["UTP Thick"] },
    { code: "통신 4-3-1", name: "UTP RS-Cable10P 이하", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.18, category: "cable", keywords: ["UTP RS-Cable10P 이하"] },
    { code: "통신 4-3-1", name: "UTP 10P 초과", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.23, category: "cable", keywords: ["UTP 10P 초과"] },
    { code: "통신 4-3-1", name: "UTP AUI", spec: "표준 규격", unit: "10m", laborType: "통신케이블공", laborFactor: 0.2, category: "cable", keywords: ["UTP AUI"] },
    { code: "통신 4-3-1", name: "Token Cable(2P)", spec: "표준 규격", unit: "10m", laborType: "통신내선공", laborFactor: 0.17, category: "cable", keywords: ["Token Cable(2P)"] },
    ...
    { code: "통신 9-1-5", name: "전선관 배관Ø50㎜이하", spec: "표준 규격", unit: "10m", laborType: "통신외선공", laborFactor: 0.12, category: "device", keywords: ["전선관 배관Ø50㎜이하"] },
    { code: "통신 9-1-5", name: "전선관 배관Ø50㎜이하", spec: "표준 규격", unit: "10m", laborType: "보통인부", laborFactor: 0.29, category: "device", keywords: ["전선관 배관Ø50㎜이하"] },
